...
const Whoweare = () => {
  return (
    <>
      <div className="max-w-screen-xl w-full mt-4 mx-auto">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="mx-auto max-w-4xl lg:text-center">
            <h2 className="text-2xl font-semibold leading-7 text-center "><span>Who we are ?</span></h2>
            <p className="mt-2  text-center   text-lg  font-bold tracking-tight sm:text-4xl">
            From Backbanchers to <span className='text-orange-600'>Travelpreneur</span> 
            </p>
