    ...
    <>
      ...
      <div className="bg-white mt-20">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-center sm:text-2xl  text-2xl  font-bold tracking-tight  sm:text-4xl"> who have helped us build holistic <span className='text-orange-600'>community</span> </h2>

        </div>
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col justify-center items-center mt-2 lg:flex-row">

          <div class="w-full lg:w-auto lg:mx-4 mt-4 ">
                    <h2 class="text-xl font-bold tracking-tight text-gray-900 text-center">Trip Captains :</h2>
                    <p class="mt-2 text-center text-sm sm:text-lg">
                      <span>
                  ...
                  <div class="w-full lg:w-auto lg:mx-4 mt-4 ">
                    <h2 class="text-xl font-bold tracking-tight text-gray-900 text-center">Local Vendors :</h2>
                    <p class="mt-2 text-center text-sm sm:text-lg">
                      <span>
                  ...
                  <div class="w-full lg:w-auto lg:mx-4 mt-4">
                    <h2 class="text-xl font-bold text-center tracking-tight text-gray-900">Trip Captains :</h2>
                    <p class="mt-2 text-center text-sm sm:text-lg">
                      <span>
                        Our trip captains are nothing short of heroes. Brave, dynamic, and great leaders, they’re certainly the showrunners of the community trips. They’ve been handpicked from India’s best travel institutes, and know all tricks of trade to lead and manage all kinds of trips, including all backpaking trips.
                      </span>
