...
const BolgeDetails = (props) => {
    return (
        <>
            <section class="max-w-screen-xl w-full mx-auto"><img src="https://img.cdn.zostel.com/blog_photo/20240203075810-makm-photography-u0irC_UnbOk-unsplash_1.jpg" alt="inside-the-blue-city-of-india" class="object-cover object-center w-full rounded-b-lg shadow-md sm:rounded-t-lg h-108 sm:h-144 2xl:192" /> 

            <section className="max-w-screen-xl rounded-lg w-full mx-auto px-4 py-4 mt-4 bg-gray-100 sm:px-0">
                <h1 class="mt-2 text-2xl font-black text-orange sm:text-4xl"><span><span>| </span>this is jodhpur trip</span></h1>
      ...
      <section className="max-w-screen-xl w-full  px-4 sm:px-0">
        <div className="max-w-5xl  my-8 mb-8 blog-content ">
          ...
          <section class="max-w-screen-xl w-full mx-auto mt-4"><img src="https://img.cdn.zostel.com/blog_photo/20240203075810-makm-photography-u0irC_UnbOk-unsplash_1.jpg" alt="inside-the-blue-city-of-india" class="object-cover object-center w-full rounded-b-lg shadow-md sm:rounded-t-lg h-108 sm:h-144 2xl:192" /> </section>
