const Kanakisli = {
    name: "Kanha Kisli National park",
    imgurl: [{
        imgurl1: "/images/tripcard/Destinationimgs/Kanha/Destination_1.png",
        imgurl2: "/images/tripcard/Destinationimgs/Kanha/Destination_4.png",
        imgurl3: "/images/tripcard/Destinationimgs/Kanha/Destination_3.png",
        imgurl4: "/images/tripcard/Destinationimgs/Kanha/Destination_2.png",
       
        
    }],
    brief: `Experience the thrill of a group adventure at Kanha National Park, nestled in the Maikal range of Madhya Pradesh. This stunning wildlife reserve, spread across 1945 sq km, offers a unique blend of excitement and natural beauty. Explore the vibrant landscapes that inspired Rudyard Kipling's "The Jungle Book," spot majestic tigers and the rare Barasingha, and marvel at the rich diversity of plants, birds, and reptiles. With well-developed infrastructure perfect for group trips, you can enjoy safaris, nature walks, and unforgettable sunsets at Bammi Dadar (Sunset Point). Kanha National Park promises a fun-filled, adventurous getaway for you and your friends.
    `,
    ...
    pickup: "Indore/Ratlam/Bhopal",
    drop: "Indore/Ratlam/Bhopal",
    it: [ {
        Heading: "Day 1: Indore to Jabalpur (Overnight Journey)",
        Schedule: [
            { Scheduledetails: "As the sun sets, an air of excitement fills the air as our travel odyssey begins." },
            { Scheduledetails: "Meet your fellow adventurers and embark on a journey to Jabalpur." },
    ...
    {
        Heading: "Day 2: Arrive in Jabalpur & Transfer to Kanha National Park",
        Schedule: [
            { Scheduledetails: "Early morning arrival in Jabalpur at 5 AM." },
            { Scheduledetails: "Transfer to Kanha National Park and check-in at your resort." },
            { Scheduledetails: "Enjoy a refreshing pool party at the resort." },
            { Scheduledetails: "Have lunch and get ready for an afternoon trek to a beautiful waterfall." },
            { Scheduledetails: "In the evening, visit a sunset point to witness the mesmerizing views." },
            { Scheduledetails: "Enjoy a delicious dinner followed by a bonfire." },
            { Scheduledetails: "Overnight stay at the resort in Kanha National Park." }
        ]
    },
    {
        Heading: "Day 3: Jungle Safari & Bhedaghat Waterfall Visit",
        Schedule: [
            { Scheduledetails: "Wake up early morning for a thrilling jungle safari (6-11 AM) in Kanha National Park." },
            { Scheduledetails: "Return to the resort, freshen up, and have breakfast." },
            { Scheduledetails: "Depart for Bhedaghat to visit the majestic Dhuandhar Waterfalls." },
            { Scheduledetails: "Explore the Marble Rocks and enjoy a boat ride on the Narmada River." },
            { Scheduledetails: "In the evening, have dinner and then transfer to Jabalpur railway station for an overnight journey back to Indore." },
            { Scheduledetails: "Overnight on the train." }
        ]
    },
    {
        Heading: "Day 4: Arrival in Indore",
        Schedule: [
            { Scheduledetails: "Early morning arrival in Indore." },
            { Scheduledetails: "Trip ends here but memories will last forever. And you can call yourself a #Traveltrekker and now part of Central India's fastest-growing and coolest community." },
            { Scheduledetails: "We hope you will join us in upcoming fun-filled trips. Keep traveling as our motto says: Work-Travel-Repeat." }
        ]
    ...
    inclusion: [
        ...
        },
        {
            "icon": "Accommodation",
            "name": "Accommodation",
            "inc": "Accommodation 3 star Hotel with Two overnight journey"
        },
        {
            "icon": "Meals",
            "name": "Meals",
        ...
        },
        {
            "icon": "Gypsy",
            "name": "Gypsy",
            "inc": "Gypsy Safari (1 Day) Along will all Forest Charges, guide charges & Entry tickets Note: Gypsy/Canter will be subject to availability."
        },
        {
            "icon": "Traveler",
            "name": "Traveler",
    ...
    exclusion: [
        ...
        },
        {
            "name": "Transport",
            "icon": "Transport",
            "inc": "Local vehicle charges may apply if unforeseen circumstances arise due to heavy crowd or if gypsy vehicles are sold out."
        },
        {
            "name": "Meals",
            "icon": "Meals",
