const Rameshwaram = {
    name: `Rameshwaram`,
    imgurl: [{
        imgurl1: "/images/tripcard/Destinationimgs/Rameshwaram/Destination_1.png",
        imgurl2: "/images/tripcard/Destinationimgs/Rameshwaram/Destination_2.png",
        imgurl3: "/images/tripcard/Destinationimgs/Rameshwaram/Destination_3.png",
        imgurl4: "/images/tripcard/Destinationimgs/Rameshwaram/Destination_4.png",
        
        
    }],
    brief: `Embark on the "Southern Sojourn Tour" and dive into a captivating group adventure through Rameshwaram, Madurai, and Kanyakumari. Begin your journey in Rameshwaram, where the sacred Ramanathaswamy Temple and serene beaches offer spiritual and scenic delights. Next, explore Madurai, home to the magnificent Meenakshi Amman Temple and bustling markets, perfect for immersing yourself in vibrant culture and history. Finally, reach Kanyakumari, the southern tip of India, where you can witness the breathtaking confluence of three oceans and enjoy stunning sunrises and sunsets. This tour promises a perfect blend of spirituality, culture, and natural beauty for an unforgettable group experience.`,
    duration: "3N-4D",
    Quadprice: "11499/-PP",
    Tripleprice: "13499/PP",
    ...
    drop: "Madurai",
    it: [ {
        "Heading": "Arrival in Madurai ",
        "Schedule": [
            { "Scheduledetails": "Start your journey by arriving in Madurai, where you will be warmly welcomed by our representative." },
            { "Scheduledetails": "check-in your pre book hotel and relax" },
           
            { "Scheduledetails": "Return to your hotel for a comfortable overnight stay in Madurai." }
        ]
    },
    {
        "Heading": "Transfer to Rameshwaram | Rameshwaram Sightseeing Tour",
        "Schedule": [
            
            { "Scheduledetails": "Enjoy a scenic drive from Madurai to Rameshwaram, one of the most sacred places in India." },
            { "Scheduledetails": "Visit the famous Ramanathaswamy Temple, known for its grand architecture and 22 theerthams (holy water bodies)." },
            { "Scheduledetails": "Explore the engineering marvel of Pamban Bridge, India's first sea bridge." },
            { "Scheduledetails": "Witness the beauty of Dhanushkodi, a ghost town with stunning beaches and historical ruins." },
            { "Scheduledetails": "Return to your hotel for a comfortable overnight stay in Rameshwaram." }
        ]
    },
    {
        "Heading": "Transfer to Kanyakumari | Kanyakumari Sightseeing Tour",
        "Schedule": [
            { "Scheduledetails": "After breakfast, embark on a drive to Kanyakumari, the southernmost tip of India where three oceans meet." },
            { "Scheduledetails": "Visit the iconic Vivekananda Rock Memorial, a serene place to reflect and enjoy the panoramic views." },
            { "Scheduledetails": "Admire the towering Thiruvalluvar Statue, dedicated to the famous Tamil poet and philosopher." },
            { "Scheduledetails": "End your day by watching the spectacular sunset at the Sunset Point, where the sky meets the sea." },
            { "Scheduledetails": "Check into your hotel for an overnight stay in Kanyakumari." }
        ]
    },
    {
        "Heading": "Transfer to Madurai | Madurai Half-day Sightseeing Tour | Departure",
        "Schedule": [
            { "Scheduledetails": "After breakfast, drive back to Madurai for a half-day sightseeing tour." },
            { "Scheduledetails": "Visit the magnificent Meenakshi Amman Temple, renowned for its intricate carvings and grand gopurams (towers)." },
            { "Scheduledetails": "Explore the historic Thirumalai Nayakkar Palace, showcasing Dravidian and Rajput architectural styles." },
            { "Scheduledetails": "Take a stroll through the Gandhi Memorial Museum, chronicling the life and work of Mahatma Gandhi." },
            { "Scheduledetails": "After the tour, transfer to Madurai airport or railway station for your onward journey, carrying wonderful memories of Tamil Nadu." }
        ]
   ...
   inclusion: [
    {
        "name": "Accommodation",
        "icon": "Accommodation",
        "inc": "3 Night stay Accommodation 3 star Hotel (1N Madhurai , 1N rameshwaram ,1N Kanyakumari)"
    },
    {
        "name": "Meals",
        "icon": "Meals",
...
exclusion: [{
    ...
    },
    {
        "name": "Tickets",
        "icon": "Tickets",
        "inc": "Entry fee or ticket to any historical monument, landmark, or sightseeing places, etc. is not included in the package (Elephant ride,Boating Etc)"
    },
    {
