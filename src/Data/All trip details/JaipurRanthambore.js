const JaipurRanthambore = {
    ...
    Venture into the wilderness of Ranthambore, where you'll have the opportunity to hear the mighty roar of Royal Bengal Tigers echoing through the jungle. Witness these majestic creatures in their natural habitat at Ranthambore National Park, a once-in-a-lifetime experience. Keep your senses sharp as you spot not only tigers but also leopards, deer, and a diverse array of bird species.
    ...
    it: [{
        Heading: "Departure from Indore & jaipur sightseeing",
        Schedule: [
            { Scheduledetails: "Group meet up. Interaction And introduction." },
            { Scheduledetails: "Enjoy the traveling experience of an overday journey to Jaipur by train (Ranthambor Exp by 6:00 am)." },
            { Scheduledetails: "Reach Jaipur and complete the check-in process at the hotel." },
            { Scheduledetails: "Proceed for local sightseeing where we shall cover Jantar-Mantar & Hawa Mahal etc." },
            { Scheduledetails: "Take hearty dinner and Overnight Stay in a hotel at Jaipur." },
            { Scheduledetails: "Note: Day-1 sightseeing will cover altogether by walking and will cover maximum places. Traveltech is not responsible if any place is left due to heavy traffic or any condition." }
        ],

    },
    {
        Heading: "Jaipur local sightseeing | khatoo shyam mandir",
        Schedule: [


            { Scheduledetails: "Wake up early in the morning and enjoy a hearty breakfast. Check out from the hotel." },
            { Scheduledetails: "Get ready to proceed for local sightseeing of Amer Fort. Enjoy an Elephant ride in Amer Fort, a jewel of Jaipur, with its majestic, beautiful architecture, and rich history." },
            { Scheduledetails: "Head towards the well-known Khatushyam Mandir(Optional), which will take approximately 1 hour and 30 minutes. Receive blessings from Lord Khatushyam Ji." },
            { Scheduledetails: "Return to Jaipur and transfer to Sawai Madhopur by train." },
            { Scheduledetails: "Reach the hotel, complete the check-in process, and enjoy some delicious dinner." },
            { Scheduledetails: "Enjoy a music night and group activities at the hotel. Overnight stay at the hotel." }
    ...
    {
        Heading: "evening safari | Explore The Land of Tigers",
        Schedule: [


            { Scheduledetails: "Wake up early in the morning and enjoy the lush green surroundings. Then, have a healthy breakfast." },
            { Scheduledetails: "Get ready to soak in the beauty of places and explore other areas." },
            { Scheduledetails: "Explore Ranthambore Fort, situated inside the park. Marvel at the imposing architecture of this spectacular fort that overlooks the entire park." },
            { Scheduledetails: "Gear up for an evening jeep safari that will take you through the heart of the forest. The safari will start around 2:00 p.m., so be ready to witness the wildlife in action over the horizon." },
            { Scheduledetails: "Hold on tight as your jeep navigates the bumpy roads of Ranthambore, which is known for its rugged terrain and lush greenery." },
            { Scheduledetails: "The highlight of the safari will undoubtedly be spotting the majestic Royal Bengal Tiger in its natural habitat. You will be left in awe as you witness these massive creatures in their element." },
            { Scheduledetails: "If luck is on your side, you might spot other majestic animals like the Barasingha, Blackbuck, Chinkara, Wild Water Buffalo, and many more. Keep your eyes peeled, and your camera ready, for you never know what surprise nature has in store for you." },
            { Scheduledetails: "Take a delicious dinner and prepare for an overnight journey to Indore." }
    ...
    },
    {
        ...
        Schedule: [
            ...
            { Scheduledetails: "In the morning, arrive at Indore by 6:40 AM." },
            { Scheduledetails: "Trip ends here but memories will last forever. You can call yourself #Traveltrekker and are now part of Central India's fastest-growing and coolest community. We hope you will join us in upcoming fun-filled trips." },
