const Ayodhya =
{
    name: "Ayodhya with Kashi and Prayagraj",
    imgurl: [{
        imgurl1: "/images/tripcard/Destinationimgs/Ayodhaya/Destination_5.png",
        imgurl2: "/images/tripcard/Destinationimgs/Ayodhaya/Destination_3.png",
        imgurl3: "/images/tripcard/Destinationimgs/Ayodhaya/Destination_1.png",
        imgurl4: "/images/tripcard/Destinationimgs/Ayodhaya/Destination_4.png",
    }],
    brief: `Join us for an exhilarating "Sacred Journey Tour" through Varanasi, Ayodhya, and Prayagraj, where history, spirituality, and adventure converge. In Varanasi, the spiritual heart of India, experience the mesmerizing Ganga Aarti and explore ancient temples. Continue to Ayodhya, the birthplace of Lord Rama, where sacred sites and temples offer a profound cultural experience. Conclude your journey in Prayagraj, witnessing the confluence of the Ganges, Yamuna, and mythical Saraswati rivers, and participate in vibrant rituals. This tour promises a unique blend of spiritual discovery and cultural immersion, perfect for an unforgettable group adventure.
    `,
    ...
    duration: "4N-5D",
    Quadprice: "9999/-PP (Min 4pax)",
    Tripleprice: "11499/PP (Min 4pax)",
    Doubleprice: "12999/PP (Min 4pax)",
    Batches: [
    ...
    drop: "Prayagraj",
        ...
        "it": [
            {
                Heading: "Arrival in Prayagraj (Allahabad)",
                Schedule: [
                    { Scheduledetails: "Arrive in Prayagraj (Allahabad) and get a warm welcome from your guide." },
                    { Scheduledetails: "Transfer to your hotel and check-in." },
                    { Scheduledetails: "Visit the sacred Triveni Sangam, the confluence of the Ganges, Yamuna, and the mythical Saraswati rivers." },
                    { Scheduledetails: "Explore Anand Bhavan, the ancestral home of the Nehru-Gandhi family." },
                    { Scheduledetails: "Visit the historic Allahabad Fort and the famous Ashoka Pillar." },
                    { Scheduledetails: "Return to your hotel for a relaxing overnight stay in Prayagraj." }
                ]
            },
            {
                Heading: "Day 2: Prayagraj to Ayodhya",
                Schedule: [
                    { Scheduledetails: "After breakfast, embark on a scenic drive to Ayodhya." },
                    { Scheduledetails: "Explore the holy city of Ayodhya, believed to be the birthplace of Lord Rama." },
                    { Scheduledetails: "Visit the Ram Janmabhoomi Temple, a significant pilgrimage site for Hindus." },
                    { Scheduledetails: "Explore Hanuman Garhi, a temple dedicated to Lord Hanuman." },
                    { Scheduledetails: "Stroll along the serene banks of the Saryu River." },
                    { Scheduledetails: "Check-in at your hotel and enjoy a peaceful overnight stay in Ayodhya." }
                ]
            },
            {
                Heading: "Day 3: Ayodhya to Varanasi",
                Schedule: [
                    { Scheduledetails: "After breakfast, drive to the ancient city of Varanasi." },
                    { Scheduledetails: "Upon arrival, check-in at your hotel and unwind." },
                    { Scheduledetails: "Visit the Kashi Vishwanath Temple, one of the most famous Hindu temples dedicated to Lord Shiva." },
                    { Scheduledetails: "Experience the enchanting Ganga Aarti ceremony on the ghats of the Ganges River." },
                    { Scheduledetails: "Return to your hotel for an overnight stay in Varanasi." }
                ]
            },
            {
                Heading: "Day 4: Varanasi Exploration",
                Schedule: [
                    { Scheduledetails: " Begin your day with a peaceful boat ride on the Ganges River at sunrise, witnessing the early morning rituals." },
                    { Scheduledetails: "Visit notable temples including Sankat Mochan Hanuman Temple, Durga Temple, and Tulsi Manas Temple." },
                    { Scheduledetails: " Explore the Bharat Mata Temple, featuring a marble relief map of India." },
                    { Scheduledetails: " Stroll through the bustling local markets and shop for souvenirs." },
                    { Scheduledetails: " Return to your hotel for a relaxing overnight stay in Varanasi." }
                ]
            },
            {
                Heading: "Day 5: Varanasi to Sarnath and Departure",
                Schedule: [
                    { Scheduledetails: " After breakfast, drive to Sarnath, where Lord Buddha delivered his first sermon." },
                    { Scheduledetails: "Visit Dhamek Stupa, Chaukhandi Stupa, and the Sarnath Archaeological Museum." },
                    { Scheduledetails: "Explore the Mulagandha Kuti Vihar and its beautiful murals." },
                    { Scheduledetails: " After the tour, transfer to Varanasi for your departure." }
                ]
            }
        ],
    ...
    inclusion: [
    {
        icon: "Accommodation",
        name: "Accommodation",
        inc: '4 night stay (1N Prayagraj,1N Ayodhya,2N Varanasi)'
    },
    {
        icon: "Meals",
        name: "Meals",
    ...
    },
    {
        icon: "Traveler",
        name: "Sedan Car",
        inc: 'Everyday commute by a Non Ac Traveler. all inner line permits for the trip; driver night charges, toll tax, parking charges.'
    },
    ...
    exclusion: [
        {
            ...
            icon: "Tickets",
            name: "Tickets",
            inc: "Monument entry tickets and expenses on any activities which are not mentioned in the itinerary."
        },
        {
            icon: "Natural_Calamities",
            name: "Natural Calamities",
            inc: `If Sedan/Suv/Sumo is unable to move due to restiction. then Traveltech will not bear the extra charges of Transportation.`
        },
    ...
    FAQ: [{
        ...
        answer: "You can reserve your spot for this trip up to 30 days before the start date. Seats are limited and allocated on a first-come, first-served basis, so make sure to secure your booking early to avoid disappointment."
    },
    {
