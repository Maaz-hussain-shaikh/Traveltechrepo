const Ladakh13daystrip = {
    ...
    imgurl: [{
        ...
        imgurl3: "/images/tripcard/Destinationimgs/Leh/Destination_8.png",
        imgurl4: "/images/tripcard/Destinationimgs/Leh/Destination_7.png",
    ...
    drop: "Delhi/Indore/bhopal/Maharastra",
       it: [
        ...
        {
            Heading: "Manali Local Sightseeing & Stay",
            Schedule: [
        ...
        {
            Heading: "Transfer to Jispa via Solang , Atal Tunnel ,Sissu",
            Schedule: [
                { Scheduledetails: "After breakfast, check out from your hotel." },
                { Scheduledetails: "Embark on a scenic drive to Jispa, passing through Solang , Atal Tunnel ,Sissu." },
                { Scheduledetails: "Enjoy the breathtaking landscapes along the way." },
                { Scheduledetails: "Check-in at your hotel in Jispa and relax." },
                { Scheduledetails: "Overnight stay in Jispa." }
            ]
        },
        {
            ...
            Schedule: [
                ...
                { Scheduledetails: "Upon arrival in Leh, check-in at your hotel and unwind." },
                { Scheduledetails: "Overnight stay in Leh." }
            ]
        },
        {
            Heading: "Leh Local Sightseeing & Stay at Nubra",
            Schedule: [
                { Scheduledetails: "After breakfast, explore the local sights of Leh." },
                { Scheduledetails: "Visit Shanti Stupa, Leh Palace, and the bustling Leh Market." },
                { Scheduledetails: "Drive to Nubra Valley, crossing the famous Khardung La Pass (Altitude - 5359m)." },
                { Scheduledetails: "Check-in at your accommodation in Nubra and relax." },
                { Scheduledetails: "Overnight stay in Nubra." }
            ]
        },
        {
            Heading: "Visit Diskit Monastery & Stay at Pangong",
            Schedule: [
                { Scheduledetails: "After breakfast, visit the ancient Diskit Monastery in Nubra." },
                { Scheduledetails: "Continue your journey to the stunning Pangong Lake (Altitude - 4225m)." },
                { Scheduledetails: "Check-in at your lakeside camp or hotel and soak in the beauty of Pangong." },
                { Scheduledetails: "Overnight stay at Pangong." }
            ]
        },
        {
            Heading: "Pangong Sightseeing & Transfer to Leh",
            Schedule: [
                { Scheduledetails: "After breakfast, explore the breathtaking views of Pangong Lake." },
                { Scheduledetails: "Transfer back to Leh, enjoying the scenic drive." },
                { Scheduledetails: "Check-in at your hotel in Leh and relax." },
                { Scheduledetails: "Overnight stay in Leh." }
            ]
        },
        {
            Heading: "Leh to Sarchu & Stay",
            Schedule: [
                { Scheduledetails: "After breakfast, check out from your hotel." },
                { Scheduledetails: "Drive to Sarchu, a high-altitude desert area." },
                { Scheduledetails: "Check-in at your camp or hotel in Sarchu and unwind." },
                { Scheduledetails: "Overnight stay in Sarchu." }
            ]
        },
        {
            Heading: "Sarchu to Kasol",
            Schedule: [
                { Scheduledetails: "After breakfast, embark on a drive to Kasol." },
                { Scheduledetails: "Enjoy the picturesque journey through the Himalayan landscapes." },
                { Scheduledetails: "Upon arrival in Kasol, check-in at your hotel." },
                { Scheduledetails: "Overnight stay in Kasol." }
            ]
        },
        {
            Heading: "Visit Manikaran Gurudwara & Drop to Delhi",
            Schedule: [
                { Scheduledetails: "After breakfast, visit the famous Manikaran Gurudwara." },
                ...
                { Scheduledetails: "Explore charming cafes at Kasol (Do Chalal trek if time permits)." },
                { Scheduledetails: "Begin your journey back to Delhi." },
                { Scheduledetails: "Overnight journey to Delhi." }
            ]
        },
        {
            Heading: "Drop to Delhi & Transfer to Bhopal/Indore",
            Schedule: [
                { Scheduledetails: "Arrive in Delhi in the morning." },
                { Scheduledetails: "Board your train or flight for your return journey to Bhopal or Indore." },
                { Scheduledetails: "End of your memorable trip." }
            ]
        }
    ],
        ...
        },
        {
            name: "Accommodation",
            icon: "Accommodation",
            inc: "Accommodation on a quad-sharing basis.(1N Manali, 1N Jispa, 2N leh, 1N pangong Lake, 1N Nubra Valley ,1N Sarchu, 1N kasol)"
        },
        {
            name: "Meals",
            icon: "Meals",
            inc: "A total of 16 meals (8 breakfasts and 8 dinners). Kindly note, considering the remoteness of the place, the supply of breakfast and dinner might have limited varieties."
        },
        {
            name: "Traveler",
            icon: "Traveler",
    ...
    FAQ: [
        { question: "How can I reach Ladakh?",
    answer: `Ladakh is one of the most popular destinations among adventure tourists, riders, photographers, and all kinds of outdoor enthusiasts. It can be reached by rail road and train networks. However, be prepared for a lot of off roading to reach your destination. There are a couple of routes you can take to reach the valley:"
    - Ladakh is a popular destination for adventure enthusiasts, photographers, and outdoor lovers.
- It can be reached by road or air.
- Two main road routes: Srinagar to Leh (434 km) and Manali to Leh (473 km).
- Buses, jeeps, and taxis are available for road travel.
- Hiring a bike from Delhi is a preferred option for riders.
- Leh Kushok Bakula Rimpochee Airport serves as the nearest airport.
- No direct train connectivity; closest railway station is Jammu Tawi.
- Key road distances: Srinagar to Leh (434 km), Manali to Leh (473 km), Leh to Nubra Valley (118 km).
- Consider exploring Leh Ladakh bike rentals for an adventurous trip.`},

{
    question: "What is the best mode of transport to reach Ladakh?",
    answer: "Opting for a self-driven vehicle, whether it's a motorcycle or a car, is the ideal way to reach Ladakh. A road journey allows you to immerse yourself in the vast Himalayan scenery at your leisure. Depending on the time of year, embarking on a road trip to Ladakh presents a plethora of new adventures and breathtaking vistas to explore."
},
{
    question: "What is the best time to visit Ladakh?",
    answer: "The prime time to visit Ladakh is during the summer months, from May to August. Most highways leading to and around Ladakh open in April, with activities picking up in May. Despite being summer, the air retains a refreshing chill, requiring blankets at night. This season also hosts numerous local festivals and events. However, trekkers brave Ladakh's extreme cold during winters, when many roads and passes are closed due to snow, posing challenges for obtaining permits to certain areas."
},
{
    question: "Which is the best route to visit Ladakh?",
...
{
    question: "Is it safe to visit Ladakh by Bike?",
    answer: "Embarking on a bike trip to Ladakh presents a unique challenge, requiring responsible riding and a focus on enjoyment over speed. While riding solo is an option, it's recommended to travel in a group due to the long and demanding roads, ensuring assistance is available if needed. However, many bikers also venture to Ladakh alone, relishing the freedom to explore unbeaten paths and less-traveled routes, forming bonds with fellow enthusiasts along the way. For first-timers or those seeking added safety, opting for a package or group tour provides flexibility with peace of mind."
},

{
    question: "Can I get rented bike to visit Ladakh?",
    answer: "Bike rentals are one of the most preferred and popular ways to visit Ladakh. It’s every bikers dream. While bike rentals are available from most connecting cities, the most preferred ones include Srinagar and Manali. Depending on which bike you choose, the cost may vary between INR800 and INR1600 per day. There is also an option to rent a bike from Delhi or Chandigarh but also be prepared for a very long ride and more nights on the road."
},
{
