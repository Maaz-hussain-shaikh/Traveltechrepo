const Kerala = {
    ...
    imgurl: [{
        ...
        imgurl2: "/images/tripcard/Destinationimgs/Kerala/Destination_5.png",
        imgurl3: "/images/tripcard/Destinationimgs/Kerala/Destination_12.png",
        imgurl4: "/images/tripcard/Destinationimgs/Kerala/Destination_7.png",
        imgurl5: "/images/tripcard/Destinationimgs/Kerala/Destination_1.png",
        imgurl6: "/images/tripcard/Destinationimgs/Kerala/Destination_6.png",
        imgurl7: "/images/tripcard/Destinationimgs/Kerala/Destination_3.png",
        imgurl8: "/images/tripcard/Destinationimgs/Kerala/Destination_4.png",
        imgurl9: "/images/tripcard/Destinationimgs/Kerala/Destination_9.png",
        imgurl10: "/images/tripcard/Destinationimgs/Kerala/Destination_10.png",
        imgurl11: "/images/tripcard/Destinationimgs/Kerala/Destination_11.png",
        imgurl12: "/images/tripcard/Destinationimgs/Kerala/Destination_2.png",
    ...
    drop: "Kochi",
    it: [{
        Heading: "Arrival at Kochi | En route Munnar | Explore the Kashmir of South India",
        Schedule: [
    
                { Scheduledetails: "Catch a flight to Kochi and upon arrival, meet our representative who will escort you to Munnar." },
                { Scheduledetails: "Drive through the picturesque hills of Munnar, often referred to as the Green Paradise of Kerala, where sprawling tea plantations and spice gardens await." },
                { Scheduledetails: "En route, marvel at the beauty of Cheeyappara and Valara waterfalls, where the cascading waters create a serene ambiance." },
                { Scheduledetails: "Upon reaching Munnar, check-in at your pre-booked hotel and unwind." },
                { Scheduledetails: "Spend the afternoon at your leisure, soaking in the tranquility of the surroundings." },
                { Scheduledetails: "In the evening, treat yourself to a refreshing cup of tea before exploring the vibrant Munnar market for some local shopping." },
                { Scheduledetails: "Relish a delicious dinner and enjoy an overnight stay at the hotel in Munnar." }
            
        ],
    },
    {
        Heading: "Awstruck views of Tea Plantations at Munnar | Sightseeing",
        Schedule: [
         
                { Scheduledetails: "Wake up to the serene surroundings of Munnar's lush green hills, enjoy a delicious breakfast, and prepare for a day of exploration." },
                { Scheduledetails: "Embark on a journey to discover Munnar's iconic attractions, including Eco Point, Blossom Park, and Hydel Park, nestled amidst misty peaks and refreshing breezes." },
                { Scheduledetails: "Visit the TATA Tea Museum to gain insights into the art of tea-making and the rich history of tea production in the region." },
                { Scheduledetails: "In the afternoon, venture to Eravikulam National Park, a haven for the endangered Nilgiri Tahr. Take part in a gentle trek through the park's unique wilderness, enjoying panoramic views of the Munnar hills." },
                { Scheduledetails: "Marvel at the breathtaking vistas from the hilltop before returning to your hotel for a relaxing evening." },
                { Scheduledetails: "Unwind with an overnight stay and indulge in a delicious dinner at your Munnar hotel." }
    ...
    {
        Heading: "Munnar to Thekkady | Drive to Periyar an area known for it's Tiger Reserve and Spice Plantations",
        Schedule: [
          
                { Scheduledetails: "Begin your day surrounded by lush greenery, enjoy a hearty breakfast, and then check out from your hotel." },
                { Scheduledetails: "Embark on a scenic journey to Thekkady, renowned as the Wildlife destination and spice hub of Kerala." },
                { Scheduledetails: "As you traverse the hills and valleys of the Western Ghats, soak in the breathtaking views along the way." },
                { Scheduledetails: "Experience the thrill of a boat ride on Periyar Lake, which meanders through the Periyar tiger reserve. Keep your eyes peeled for sightings of the majestic big cat and other wildlife such as elephants, bison, sambar, and deer." },
                { Scheduledetails: "After an exhilarating wildlife safari, settle in for an overnight stay and enjoy a delicious dinner at your hotel in Thekkady." }
    
            
        ]
    },
    {
        Heading: "The Land Of Lush Blue Lagoons - Alleppey",
        Schedule: [
            
                { Scheduledetails: "Start your day with a refreshing morning and enjoy a delicious breakfast." },
                { Scheduledetails: "Complete the check-out process at the hotel and begin your journey to Alleppey." },
                { Scheduledetails: "Upon reaching Alleppey, immerse yourself in a unique and breathtaking experience by shikara Ride at serence backwaters" },
                { Scheduledetails: "Later, step out to ride a shikara at serene backwaters, and explore Alleppey Beach, Lighthouse, and Floating Bazaar. Expect a brilliant orange and pink sunset from the beach, a splendid view of the Arabian Sea from the lighthouse, and local delicacies at Floating Bazaar. " },
                { Scheduledetails: "Complete check-in Process Take testy Dinner and Enjoy an overnight stay at the Hotel," }
    ...
    },
    {
        ...
        Schedule: [
                ...
                { Scheduledetails: "Enjoy a delicious and healthy breakfast on the deck, surrounded by the classic coastal ambiance." },
                { Scheduledetails: "Pack your bags and prepare for departure to Kochi." },
                { Scheduledetails: "En route to Kochi, if time permits, indulge in sightseeing at Cochin fort, Marine Drive, and other attractions." },
                { Scheduledetails: "Arrive in Kochi on time to board your flight." },
                { Scheduledetails: "The trip ends here, but the memories will last a lifetime. You are now officially a #Traveltrekker and part of Central India's fastest-growing and coolest community." },
