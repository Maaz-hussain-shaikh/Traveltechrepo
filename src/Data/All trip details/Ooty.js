const Ooty = {
    name: `Ooty "Blissful Karnataka-Tamil Nadu Tour "`,
    imgurl: [{
        imgurl1: "/images/tripcard/Destinationimgs/Ooty/Destination_3.png",
        imgurl2: "/images/tripcard/Destinationimgs/Ooty/Destination_1.png",
        imgurl3: "/images/tripcard/Destinationimgs/Ooty/Destination_4.png",
        imgurl4: "/images/tripcard/Destinationimgs/Ooty/Destination_2.png",
        
        
    }],
    brief: `"Embark on the "Blissful Karnataka-Tamil Nadu Tour" with a thrilling group adventure to Ooty, the Queen of Hill Stations. Nestled in the Nilgiri Hills, Ooty offers a perfect blend of scenic beauty and fun activities. Wander through lush tea gardens, take a ride on the charming Nilgiri Mountain Railway, and explore the vibrant botanical gardens. Experience the serene Ooty Lake with boat rides and picnics, and enjoy panoramic views from Doddabetta Peak. This tour promises a memorable getaway, combining the tranquility of nature with the excitement of exploring one of India's most beloved hill stations."`,
    duration: "4N-5D",
    Quadprice: "12499/-PP",
    ...
    it: [ {
        ...
        Schedule: [
            ...
            { "Scheduledetails": " Check-in at your hotel in Mysore and relax after the day's exploration." },
            { "Scheduledetails": " Overnight stay in Mysore." }
        ]
    },
    {
        ...
        Schedule: [
            ...
            { "Scheduledetails": " Check-in at your hotel in Ooty and unwind amidst the tranquil surroundings." },
            { "Scheduledetails": " Spend the evening at leisure, soaking in the serene ambiance of Ooty." },
            { "Scheduledetails": " Overnight stay in Ooty." }
        ]
    },
    {
        ...
        Schedule: [
            ...
            { "Scheduledetails": " Return to Ooty in the evening and check-in at your hotel for overnight stay." },
            { "Scheduledetails": " Enjoy the panoramic views and pleasant weather of Ooty." },
            { "Scheduledetails": " Overnight stay in Ooty." }
        ]
    },
    {
        ...
        Schedule: [
            ...
            { "Scheduledetails": " Drop-off at your desired location in Bangalore, marking the end of your memorable trip." }
        ]
    }
    ],
   inclusion: [{
