...
{ 
    id: 1, 
    date: 'Batch-1 (8th Nov to 14th Nov)' 
},
{ 
    id: 2, 
    date: 'Batch-2 (15th Nov to 21st Nov)' 
},
{ 
    id: 3, 
    date: 'Batch-3 (22nd Nov to 28th Nov)' 
},
{ 
    id: 4, 
    date: 'Batch-4 (29th Nov to 5th Dec)' 
},
{ 
    id: 5, 
    date: 'Batch-5 (6th Dec to 12th Dec)' 
},
{ 
    id: 6, 
    date: 'Batch-6 (13th Dec to 19th Dec)' 
},
{ 
    id: 7, 
    date: 'Batch-7 (20th Dec to 26th Dec)' 
},
{ 
    id: 8, 
    date: 'Batch-8 (27th Dec to 2nd Jan)' 
}
    ],
    ...
    it: [{
        ...
        Schedule: [
            { Scheduledetails: "Group meet-up for interaction and introductions." },
            { Scheduledetails: "Welcome aboard with other groups." },
            { Scheduledetails: "Reporting time will be updated according to train timing." },
            { Scheduledetails: "Begin the 24-hour journey to Goa." },
            { Scheduledetails: "No meals provided during travel." },
            { Scheduledetails: "Train tickets will be booked based on availability (Mangla Express/Maru Sagar Express)." },
            { Scheduledetails: "Fare from Bhopal to Bhopal included in the package. Any extra charges for confirmed tickets to be borne by the customer." }


        ]
    },
    {
        Heading: " Explore Candolim beach",
        Schedule: [
            { Scheduledetails: "Reach Goa in the afternoon/evening." },
            { Scheduledetails: "Transfer to hotel/resort and complete check-in." },
            { Scheduledetails: "Relax and enjoy a pool party at the hotel." },
            { Scheduledetails: "Witness the sunset at Candolim/Calangute beach (walking distance from hotel)." },
            { Scheduledetails: "Enjoy a delicious dinner." },
            { Scheduledetails: "Overnight stay at resort/hotel." }
    ...
    {
        Heading: "North goa sightseeing",
        Schedule: [
            { Scheduledetails: "Get up early in the morning, have breakfast, and get ready for North Goa sightseeing." },
            { Scheduledetails: "Visit Anjuna beach, Vagator beach, Baga beach, Calangute beach, Fort Agwada, and enjoy a dolphin trip (350/- per person, self-arranged)." },
            { Scheduledetails: "Explore beach shacks, flea markets, and other attractions." },
            { Scheduledetails: "After a beautiful evening at the beach, enjoy a tasty dinner." },
            { Scheduledetails: "Overnight stay at Resort/Hotel." }

        ]
    },
    {
        Heading: "South goa sightseeing",
        Schedule: [
            { Scheduledetails: "Get up early in the morning, have breakfast, and get ready for South Goa sightseeing." },
            { Scheduledetails: "Visit Old Goa church, Mangueshi temple, Dona Paula jetty, Miramar beach, Panjim city, and enjoy a boat river cruise (500 per head)." },
            { Scheduledetails: "Enjoy the vibes flocked with foreigners at the beach." },
            { Scheduledetails: "Explore local food, beautiful restaurants, etc." },
            { Scheduledetails: "Overnight stay at Resort/Hotel." }
    ...
    {
        Heading: "Dudhsagar water waterfall/Watersports",
        Schedule: [
            { Scheduledetails: "After breakfast, check out from the hotel/resort." },
            { Scheduledetails: "Get up early in the morning and get ready to explore the Dudhsagar waterfall track. Alternatively, you can also enjoy watersports activities whole day." },
            { Scheduledetails: "After completing the Dudhsagar waterfall/Watersoprts self exploration, explore Goa market, clubs, by your (own)." },
            { Scheduledetails: "Meet up point at the hotel at 12:00 AM from where we can reach the railway station. (Train timing: 2:30 AM from Thivim to Bhopal.)" },
            { Scheduledetails: "Last day sightseeings/activities are not included in the package." }

        ]

    },
    {
        Heading: "Return To Bhopal",
        Schedule: [
            { Scheduledetails: "Goa to your destination by train (Sleeper)." },
            { Scheduledetails: "Train timing is 2:30 AM from Thivim railway station." },
...
thingstotake: [{
    ...
    FAQ: [
        {
            question: "How many days required to visit goa?",
            answer: "A trip to Goa typically lasts around 4 to 7 days, allowing time to enjoy the beaches, water sports, nightlife, and local culture."
        },

        {
            question: "Which is the nearest airport for goa?",
            answer: "The nearest airport to Goa is Dabolim Airport (GOI), also known as Goa International Airport. It is located in Dabolim, which is approximately 29 kilometers (18 miles) from the state capital, Panaji, and serves as the primary airport for domestic and international flights to and from Goa."
        },
        {
            question: "Which are the best places to visit in Goa",
            answer: "The best places to visit in Goa include its famous beaches like Baga and Calangute, historical sites in Old Goa such as the Basilica of Bom Jesus, Dudhsagar Waterfalls, Fort Aguada, spice plantations, Panaji city, the Anjuna Flea Market, Chapora Fort, casino cruises, and Dudhsagar Spice Village."
        },
        {
