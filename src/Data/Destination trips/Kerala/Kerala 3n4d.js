const Kerala3n4d =
{
    ...
    drop: "Kochi",
        ...
        "it": [
            {
                "Heading": "Day 1: Arrival in Kochi | Transfer to Munnar",
                "Schedule": [
                    { "Scheduledetails": "Arrive in Kochi and meet our representative." },
                    { "Scheduledetails": "Transfer to Munnar, known as the Green Paradise of Kerala." },
                    { "Scheduledetails": "En route, admire Cheeyappara, Athirappilly Waterfalls, and Valara waterfalls." },
                    { "Scheduledetails": "Check-in at the hotel and relax." },
                    { "Scheduledetails": "Explore the vibrant Munnar market in the evening." },
                    { "Scheduledetails": "Enjoy dinner and overnight stay in Munnar." }
                ]
            },
            {
                "Heading": "Day 2: Munnar Sightseeing Tour",
                "Schedule": [
                    { "Scheduledetails": "Visit Eco Point, Blossom Park, and Hydel Park." },
                    { "Scheduledetails": "Explore the TATA Tea Museum to learn about tea-making." },
                    { "Scheduledetails": "Discover Eravikulam National Park and trek through its wilderness." },
                    { "Scheduledetails": "Return to the hotel for dinner and overnight stay in Munnar." }
                ]
            },
            {
                "Heading": "Day 3: Arrival in Alleppey",
                "Schedule": [
                    { "Scheduledetails": "Check-out from the hotel and travel to Alleppey." },
                    { "Scheduledetails": "Check-in to the houseboat and enjoy lunch." },
                    { "Scheduledetails": "Experience a shikara ride in the serene backwaters." },
                    { "Scheduledetails": "Explore Alleppey Beach, Lighthouse, and Floating Bazaar." },
                    { "Scheduledetails": "Enjoy dinner and overnight stay on the houseboat." }
                ]
            },
            {
                "Heading": "Day 4: Departure from Kochi",
                "Schedule": [
                    { "Scheduledetails": "After breakfast on the houseboat, check-out and proceed to Kochi." },
                    { "Scheduledetails": "Reach Kochi Airport/Railway station for your onward journey." },
                    { "Scheduledetails": "End of the tour with fond memories of Kerala's landscapes." }
                ]
            }
        ],
    ...
    },
    {
        icon: "Accommodation",
        name: "Accommodation",
        inc: '3 night stay (2N Munnar Hotel 1N alleppey in Houseboat)'
    },
    {
        icon: "Meals",
        name: "Meals",
    ...
    },
    {
        icon: "Traveler",
        name: "Sedan Car",
        inc: 'Everyday commute by a Non Ac Sedan/Suv/Sumo. all inner line permits for the trip; driver night charges, toll tax, parking charges.'
    },
    ],
    exclusion: [
        {
        ...
        },
        {
            ...
            inc: `If Sedan/Suv/Sumo is unable to move due to Snowfall, Landslide, etc. then Traveltech will not bear the extra charges of small 4x4. Either wait till clearing or Pay for the extra service.or Any cost arising due to natural calamities.`
        },
