const Kashmir4n5d = {
    ...
    Nestled in the northernmost part of the Indian subcontinent, Kashmir awaits with its breathtaking vistas, creating a dreamy backdrop for your romantic escapade. Bordered by Pakistan, India, and China, this enchanting region boasts snow-capped mountains, shimmering lakes, verdant valleys, and picturesque meadows.
    
    Embark on a journey to the iconic Kashmir Valley, where romance flourishes amidst the enchanting attractions of Dal Lake, Mughal Gardens, and Shankaracharya Temple. Glide hand in hand on traditional houseboats, known as shikaras, and let the serenity of the waterways envelop you in tranquility.
    
    For adventurous souls, Kashmir offers a playground of thrills amidst its majestic mountains. Trek through scenic trails, conquer snowy peaks with skiing adventures, and share exhilarating moments in the embrace of nature's grandeur.
    
    Indulge your senses in Kashmir's culinary delights, a delightful fusion of Indian, Persian, and Central Asian flavors. Sample dishes like Rogan Gosh, Gushtaba, and Kashmiri Pulao, igniting a symphony of flavors that mirror the region's rich cultural heritage.
    ...
    {
        Heading: " Pahalgam sightseeing | A Quiet Little Town Adorned with a blanket of Pine Trees and Crystal-Clear Rivers",
        Schedule: [
    ...
    {
        Heading: "Excursion to Gulmarg | The Meadow of Flowers where you can Enjoy the Second Highest Cable Car Ride in the World",
        Schedule: [
            { Scheduledetails: "After having a sumptuous breakfast, head towards the crown jewel of Kashmir, Gulmarg." },
            { Scheduledetails: "Reach Gulmarg, meaning The Meadow of Flowers, which is also a very popular Ski Resort." },
            { Scheduledetails: "See the breathtaking views of the Kashmir Valley and the snowy peaks around as you take a ride on the 2nd Highest Gondola (at your own cost if weather permits) in the world." },
            { Scheduledetails: "Later, you can try sliding down the slopes by trying your hand at skiing and snowboarding (At your own cost)." },
            { Scheduledetails: "Head back to Srinagar." },

            { Scheduledetails: "Have a delicious dinner and an overnight stay at a houseboat in Srinagar." },
            {
                Scheduledetails: `Note- Cable car at Gulmarg will be excluded from this package Book your cable car tickets before at least 15 days before trip (1900 for both phases for the 3+ age group )
            All the sightseeing are coved only if time permits (i.e subject to availability.` }

        ]
    },
    {
        Heading: "Excursion to Sonmarg | Walk around the Famed Golden Meadows of Sonamarg",
        Schedule: [
            { Scheduledetails: "After an early morning breakfast, check out from the hotel." },
            { Scheduledetails: "Proceed to the Meadow of Gold with your better half and take in the mesmerizing scenery on the way, cherishing the last few hours of your amazing honeymoon." },
            { Scheduledetails: "Sonamarg is a town surrounded by breathtaking glaciers and serene lakes, covered in snow with beautiful flower-laden meadows in the majestic Himalayas." },
            { Scheduledetails: "Take a pony ride to Thajiwas Glacier that offers a stunning view of the frozen lake lined with emerald meadows and a clear blue sky." },
            { Scheduledetails: "Walk along the exotic grasslands of Baltal to explore the untouched beauty of Sonmarg." },
            { Scheduledetails: "Once done exploring the beauty of Sonmarg, head back to Srinagar." },
            { Scheduledetails: "Complete the check-in process, have a delicious dinner, and enjoy an overnight stay in a houseboat." }
    ...
    {
        Heading: "Sightseeing in Srinagar | Walk the Beautiful Mughal Gardens with a Variety of Colorful Flowers",
        Schedule: [
            { Scheduledetails: "After an early morning breakfast with your partner, complete the check-out formalities and proceed to the desired drop-off location in Srinagar." },
            { Scheduledetails: "Stroll around the famous landscapes created by the Mughals and watch the sunset over the Dal Lake as you embark on your Shikara Ride on its rolling waters." },
            { Scheduledetails: "If time permits, you will then be visiting the marvelous Mughal creations starting with the Chashmi-E-Shahi, which is a natural water spring." },
            { Scheduledetails: "You will also visit the Shankaracharya Temple and Hazratbal Shrine." },
            { Scheduledetails: "This brings your Kashmir honeymoon tour package to an end with beautiful memories." },
            { Scheduledetails: "Drop off at the airport" }
