const Rishikeshharidwar =
{
    ...
    brief: `Celebrate your romantic milestones with your soulmate amidst the breathtaking landscapes of Rishikesh, Haridwar, and Mussoorie. Stroll hand in hand along the serene banks of the Ganges in Rishikesh, with the ancient temples and lush greenery as your backdrop. Explore the spiritual essence of Haridwar as you witness the evening aarti on the ghats of the holy river. In Mussoorie, experience the enchanting beauty of the Queen of Hills with its cascading waterfalls and panoramic mountain views. Travel along winding mountain roads to Mussoorie, where you'll be enchanted by the serene ambiance and romantic charm of this picturesque hill station. Immerse yourselves in the spiritual aura of Rishikesh and Haridwar, where love resonates in every sacred corner, creating unforgettable moments for you and your partner. Join us on a group trip with strangers and let TravelTech make your romantic getaway an unforgettable experience!
    `,
    ...
    drop: "Indore/Bhopal/Delhi",
        ...
        "it": [
            ...
            {
                "Heading": "Delhi to Rishikesh - Embrace the Spiritual Vibes",
                "Schedule": [
                    { "Scheduledetails": "After breakfast, depart from Delhi and head towards Rishikesh." },
                    { "Scheduledetails": "Upon arrival, check-in at your hotel and relax." },
                    { "Scheduledetails": "Spend the day exploring the spiritual vibes and serene beauty of Rishikesh." },
                    { "Scheduledetails": "Overnight stay in Rishikesh." }
                ]
            },
            {
                "Heading": "Enchanting Mussoorie Beckons - Explore & Relax",
                "Schedule": [
                    { "Scheduledetails": "Depart from Rishikesh to Mussoorie after breakfast." },
                    { "Scheduledetails": "En route, enjoy the scenic drive and visit the beautiful sights of Dehradun." },
                    { "Scheduledetails": "Upon reaching Mussoorie, check-in at your hotel." },
                    { "Scheduledetails": "Spend the day visiting popular attractions such as Gun Hill, Kempty Falls, and Company Garden." }, {"Scheduledetails":  "Enjoy leisurely strolls along the Mall Road, indulging in shopping and local delicacies" },
                    { "Scheduledetails": "Overnight stay in Mussoorie." }
                ]
            },
            {
    ...
    },
    {
        icon: "Accommodation",
        name: "Accommodation",
        inc: '2 night stay with 2 overnight journey. (1N Rishikesh, 1 Night Masoorie,)'
    },
    {
        icon: "Meals",
        name: "Meals",
    ...
    exclusion: [
        {
            ...
            icon: "Tickets",
            name: "Tickets",
            inc: "Monument entry tickets and expenses on any activities (Riverrafting,Bungee junming etc) which are not mentioned in the itinerary."
        },
        {
