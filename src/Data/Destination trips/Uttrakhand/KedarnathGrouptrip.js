const KedarnathGroup = {
    name: "Kedarnath Gorup trip ",
    imgurl: [{
    ...
    Kedarnath holds religious significance as one of the Char Dham pilgrimage sites. The temple, dedicated to Lord Shiva, is believed to have been established by Adi Shankaracharya in the 8th century at an elevation of 3,583 meters. Be awestruck by the marvelous architecture adorned with intricate designs against the stunning backdrop of snow-covered peaks.
    ...
    duration: "5N-6D",
    Quadprice: "8999/-PP",
    Tripleprice: "10499/PP",
    Doubleprice: "12499/PP",
    Batches: [
        { 
            id: 1, 
            date: 'Batch-1 (2nd May to 7th May)' 
        },
        { 
            id: 2, 
            date: 'Batch-2 (9th to 14th May)' 
        },
        { 
            id: 3, 
            date: 'Batch-3 (16th to 21st May)' 
        },
        { 
            id: 4, 
            date: 'Batch-4 (23rd to 28th May)' 
        },
        { 
            id: 5, 
            date: 'Batch-5 (30th May to 4th Jun)' 
        },
        { 
            id: 6, 
            date: 'Batch-6 (6th to 11th Jun)' 
        },
        { 
            id: 7, 
            date: 'Batch-7 (13th to 18th Jun)' 
        },
        { 
            id: 8, 
            date: 'Batch-8 (20th to 25th Jun)' 
        },
        { 
            id: 9, 
            date: 'Batch-9 (27th to 2nd July)' 
        }
    ],
    pickup: "Delhi",
    drop: "Delhi",
    it: [
        {
            Heading: "Delhi to Guptakashi | Overnight Journey",
            Schedule: [
                { Scheduledetails: "Departure from Delhi at 8:30 PM in a comfortable traveler." },
                { Scheduledetails: "Enjoy a scenic overnight journey through the majestic Himalayan foothills." },
                { Scheduledetails: "📌 'Know the true value of time; snatch, seize, and enjoy every moment of it.'" }
            ]
        },
        {
            Heading: "Arrival at Guptakashi | Rest & Acclimatization",
            Schedule: [
        ...
        {
            Heading: "Trek to Kedarnath | Stay Near Kedarnath Temple",
            Schedule: [
                { Scheduledetails: "2:00 AM – Wake up, freshen up, and prepare for the trek. (No breakfast will be served due to early departure.)" },
                { Scheduledetails: "3:00 AM – Checkout and drive to Sonprayag." },
                { Scheduledetails: "Take a local taxi from Sonprayag to Gaurikund (₹100 per person approx.), the trek’s starting point." },
        ...
        {
            Heading: "Kedarnath to Sonprayag | Stay at Guptakashi",
            Schedule: [
                { Scheduledetails: "Early morning temple darshan and peaceful moments in the divine surroundings." },
                { Scheduledetails: "Enjoy a delicious breakfast before starting the return trek." },
                { Scheduledetails: "Descend towards Gaurikund (22 km). Ponies and palanquins are available at an additional cost." },
                { Scheduledetails: "Take a government taxi from Gaurikund to Sonprayag." },
                { Scheduledetails: "Proceed to Guptakashi/Rampur (A short 1 km walk may be required at Sonprayag due to vehicle restrictions)." },
                { Scheduledetails: "Relax after a long day, enjoy dinner, and unwind." },
                { Scheduledetails: "Overnight stay in Guptakashi." }
            ]
        },
        {
            Heading: "Sonprayag to Rishikesh | Explore Haridwar | Overnight Journey to Delhi",
            Schedule: [
                { Scheduledetails: "Wake up, have breakfast, and enjoy the serene mountain sunrise." },
                { Scheduledetails: "Depart for Rishikesh, the Yoga Capital of the World." },
                { Scheduledetails: "Explore Ram Jhula, Laxman Jhula, and visit Ganga-side cafés." },
                { Scheduledetails: "If time permits, stop at Haridwar to witness the divine Ganga Aarti at Har Ki Pauri." },
                { Scheduledetails: "Overnight journey to Delhi with unforgettable spiritual memories." }
            ]
        },
        {
            Heading: "Arrival in Delhi | Trip Ends with Lifelong Memories",
            Schedule: [
                { Scheduledetails: "Reach Delhi early morning." },
                { Scheduledetails: "Trip ends, but the memories last forever!" },
                { Scheduledetails: "📌 'Work - Travel - Repeat!' ✈️ See you on your next adventure! 🌍" }
            ]
        }
    ],
    inclusion: [
