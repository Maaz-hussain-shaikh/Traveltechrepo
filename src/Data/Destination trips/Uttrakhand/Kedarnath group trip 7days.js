const Kedarnath = {
    ...
    Batches: [
        {id: 1,date: 'Batch-8 (9th to 15th May)'},
        {id: 2,date: 'Batch-9 (16th to 22nd May)'},
        {id: 3,date: 'Batch-10 (23rd to 29th May)'},
        {id: 4,date: 'Batch-11 (30th May to 5th Jun)'},
        {id: 5,date: 'Batch-12 (6th to 12th Jun)'},
        {id: 6,date: 'Batch-13 (13th to 19th Jun)'},
        {id: 7,date: 'Batch-14 (20th to 26th Jun)'}
    ],
    ...
    it: [{
        ...
        Schedule: [
            ...
            { Scheduledetails: "Enjoy the traveling experience of an overnight journey to Delhi by train." },
    ...
    },
    {
        ...
        Schedule: [
            ...
            { Scheduledetails: "note-traveller will be park in parking all sightseeing cover altogether by walking " }
        ]
    },
    {
        ...
        Schedule: [
            ...
            { Scheduledetails: "Check-in at the hotel upon reaching Guptkashi." },
            { Scheduledetails: "Overnight stay at Guptkashi." }

        ]
    },
    {
        Heading: "Guptkashi to Kedarnath Trek",
        Schedule: [
            { Scheduledetails: "Enjoy a delicious breakfast before proceeding from Guptkashi to Sonprayag. Travelers will park in the parking." },
            { Scheduledetails: "Upon reaching Sonprayag, walk to the Government Union taxi stand to reach Gaurikund. Walk for 1-2 km as no private vehicles are allowed in Gaurikund." },
    ...
    {
        Heading: " Kedarnath to Haridwar Return Journey",
        Schedule: [
            { Scheduledetails: "Wake up early for temple darshan and spend some peaceful time." },
            { Scheduledetails: "Enjoy a delicious breakfast." },
            { Scheduledetails: "Head towards Gaurikund from Kedarnath. You can opt for ponies or palanquins for a more comfortable journey (own expense)." },
    ...
    {
        Heading: "Haridwar Sightseeing and Return to Delhi",
        Schedule: [
            { Scheduledetails: "Arrive in Haridwar in the morning." },
    ...
    {
        Heading: "Farewell to the Mountains",
        Schedule: [
            { Scheduledetails: "As we bid goodbye to the majestic mountains," },
            { Scheduledetails: "We drop you back at your home," },
            { Scheduledetails: "With hearts full of cherished memories and souls filled with the devotion of Lord Shiva," },
            { Scheduledetails: "Your once-in-a-lifetime dream has come true." },
            { Scheduledetails: "And amidst this journey, you've formed unbreakable bonds with strangers turned friends." },
            { Scheduledetails: "Now, you can proudly call yourself a #TravelTrekker," },
