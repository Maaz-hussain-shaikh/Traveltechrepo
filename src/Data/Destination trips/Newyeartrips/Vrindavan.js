const Vrindavan = {
    name: " Braj Ki Holi ",
    imgurl: [{
        imgurl1: "/images/tripcard/Destinationimgs/Varanasi/Destination_1.jpg",
        imgurl2: "/images/tripcard/Destinationimgs/Varanasi/Destination_2.jpg",
        imgurl3: "/images/tripcard/Destinationimgs/Varanasi/Destination_3.jpg",
        imgurl4: "/images/tripcard/Destinationimgs/Varanasi/Destination_4.jpg",
        

    }],
    brief: "Get ready for the wildest, most colorful, and unforgettable Holi of your life as TravelTech takes you to the land of Krishna’s divine mischief – Mathura & Vrindavan! Imagine dancing in the streets with gulal flying everywhere, chanting “Radhe Radhe”, and experiencing the legendary Lathmar Holi in Barsana, where playful chaos meets tradition!  The best part? You’re not going alone! This is a strangers’ trip where you’ll meet like-minded explorers, turn strangers into friends, and create memories that will last forever! Whether it's witnessing Phoolon Ki Holi at Banke Bihari Temple, getting lost in the narrow colorful alleys of Vrindavan, or vibing with the energy of thousands celebrating together, every second will be pure magic! ✨ With TravelTech, everything is sorted—comfortable stays, seamless transport, delicious food, and non-stop fun! All you need to do is pack your bags, bring your energy, and let’s paint Braj in the craziest hues of Holi! ",
    ...
    Batches: [
        ...
        { 
            id: 1, 
            date: 'Batch-1 (8th to 12th Mar)' 
        },
        { 
            id: 2, 
            date: 'Batch-2 (12th to 16th Mar)' 
        },
        
        
    ],
    pickup: "Indore/Vrindavan",
    drop: "Indore/Vrindavan",
    it: [ {
        Heading: "Indore to Vrindavan (Overnight Journey)",
        Schedule: [
            ...
            { Scheduledetails: "Small trip briefing session conducted by the team captain." },
            { Scheduledetails: "Depart from Indore for an exciting Holi adventure! " }
        ]
    },
    {
        Heading: "Arrival in Vrindavan | Sightseeing",
        Schedule: [
            { Scheduledetails: "Check-in & refresh at the hotel. " },
            { Scheduledetails: "Explore Govardhan Parvat & Nandgaon – The land of Krishna’s childhood. " },
            { Scheduledetails: "Evening at leisure in the divine ambiance of Vrindavan. ✨" },
            { Scheduledetails: "Overnight stay & dinner at the hotel. " }
        ]
    },
    {
        Heading: " Braj Ki Holi Festival – Gokul & Vrindavan",
        Schedule: [
            { Scheduledetails: "Start your day with a delicious breakfast. " },
            { Scheduledetails: "Immerse yourself in the world-famous Braj Ki Holi in Gokul. " },
            { Scheduledetails: "Visit Banke Bihari Temple & ISKCON Temple to witness Holi like never before! " },
            { Scheduledetails: "Evening visit to Prem Mandir – A mesmerizing spiritual experience. " },
            { Scheduledetails: "Overnight stay & dinner at the hotel. " }
        ]
    },
    {
        Heading: " Mathura Sightseeing & Departure",
        Schedule: [
            { Scheduledetails: "Check-out at 9 AM. " },
            { Scheduledetails: "Visit Shri Krishna Janmabhoomi for a divine end to your journey. " },
            { Scheduledetails: "Depart for Indore with unforgettable memories. " }
        ]
    },
    {
        Heading: "Arrival in Indore",
        Schedule: [
            { Scheduledetails: "Return home with cherished memories flavored with the essence of Braj Ki Holi." },
            { Scheduledetails: "Embrace the title of #Traveltrekker and join India's fastest-growing travel community." },
            { Scheduledetails: "Follow our motto: 'Work-Travel-Repeat'." }
        ]
    }
    ],
    inclusion: [  {
