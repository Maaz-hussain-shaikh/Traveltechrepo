const Pushkar = {
    name: "Pushkar Holi trip",
    imgurl: [{
        imgurl1: "/images/tripcard/Destinationimgs/Pushkar/Destination1.jpg",
        imgurl2: "/images/tripcard/Destinationimgs/Pushkar/Destination2.jpg",
        imgurl3: "/images/tripcard/Destinationimgs/Pushkar/Destination3.jpg",
        imgurl4: "/images/tripcard/Destinationimgs/Pushkar/Destination4.jpg",
        

    }],
    brief: "Get ready for the wildest, most electrifying Holi celebration in the spiritual and vibrant town of Pushkar! The streets come alive with thumping beats, energetic dance, and an explosion of colors, creating an atmosphere like no other. As you step into this surreal festival, you’ll be drenched in gulal, joy, and pure euphoria, surrounded by travelers from all over the world! The best part? This is not just a trip; it’s an experience! With TravelTech, you’ll be traveling with a group of strangers who will soon turn into lifelong friends. Whether it’s dancing to the beats of dhol, witnessing the chaos of colors, or just soaking in the magical Pushkar vibe, every moment will be legendary! We’ve got you covered—hassle-free travel, comfy stays, and the craziest Holi adventure of your life! So pack your bags, bring your energy, and let’s paint Pushkar in every color imaginable",
    ...
    Doubleprice: "6999/PP",
    off:"",
    DiscountQuadprice: "6999/-",
    DiscountTripleprice: "7499/-",
    DiscountDoubleprice: "8999/-",
    Batches: [
       
         
        { 
            id: 1, 
            date: 'Batch-1 (13th to 15th Mar)' 
        },
         ...
         [
            ...
            },
            {
                ...
                Schedule: [
                    ...
                    { "Scheduledetails": "Enjoy a leisurely dinner at the hotel." },
                    { "Scheduledetails": "Overnight stay at the hotel." }
                ]
            },
            {
                Heading: "Ajmer Sightseeing & Return to Indore",
                Schedule: [
                    { "Scheduledetails": "Wake up early and enjoy a delicious Rajasthani-style breakfast." },
                    { "Scheduledetails": "Pack your bags and check out from the hotel." },
