const NewJodhpur = {
    ...
    Batches: [
        ...
        { 
            id: 1, 
            date: 'Batch-1 (19th to 22nd Dec)' 
        },
        { 
            id: 2, 
            date: 'Batch-2 (29th Dec to 1st Jan)' 
        },
    ...
    it: [{
        ...
        Schedule: [
            { Scheduledetails: "Reach Jodhpur in the Morning,check-in at the hotel" },
            { Scheduledetails: "Visit Mehrangarh Fort, Jaswant Thada, and Umaid Bhavan Palace" },
            { Scheduledetails: "In the evening, visit Local markets, clock tower and local attraction" },
            { Scheduledetails: " Have a delicious dinner and overnight stay at the hotel" }, 
            ],
                        
    },
    {
        Heading: "Proceed to Jaisalmer (31 st Dec)| Dune night camping & New Year Celebration ",
        Schedule: [
                { Scheduledetails: "Start your day with a healthy breakfast and begin your journey." },                
                { Scheduledetails: "Transfer to Jaisalmer sand dunes and be welcomed with Rajasthani culture and drinks." },
                { Scheduledetails: "Get ready for an adventure at the sand dunes. Enjoy the Desert safari & Camel safari at sand dunes" },
                { Scheduledetails: "Enjoy folk dance with a bonfire accompanied by chai and coffee." },
                { Scheduledetails: "Enjoy New year celebration at campsite." },
    ...
    },
    {
        ...
        Schedule: [
                ...
                { Scheduledetails: "After enjoying the sunset at Gadisar Lake, head towards Jodhpur for an overnight journey." },
                { Scheduledetails: "Note: Sightseeing will cover altogether by walking or Tuk-Tuk at own cost(No Outside vehicles allowed in jaisalmer fort" }
    ...
    },
    {
        ...
        Schedule: [
                ...
                { Scheduledetails: "Return journey starts from Jodhpur by train at morning 5:00 A.M.." },
                { Scheduledetails: "The trip ends here but memories will be everlasting forever." },
                { Scheduledetails: "You can call yourself #Traveltrekker and now part of Central India's fastest-growing and coolest community." },
                { Scheduledetails: "And we hope you will join us in upcoming fun-filled trips." },
   ...
   inclusion: [
        ...
        },
        {
            "icon": "Accommodation",
            "name": "Accommodation",
            "inc": "2 Night stay (1N Hotel , 1N Desert Camps) "
        },
        {
            "icon": "Meals",
            "name": "Meals",
