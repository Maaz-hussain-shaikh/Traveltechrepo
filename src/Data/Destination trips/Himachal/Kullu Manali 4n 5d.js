const NewKullumanali4n5d =
{
    ...
    brief: `Celebrate your romantic milestones with your soulmate amidst the enchanting landscapes of Himachal Pradesh, where snow-capped mountains, wooded deodar forests, and verdant landscapes create the perfect backdrop for your love story. Enjoy leisurely strolls along the Mall Road in Manali, with the majestic Mall Road Manali providing a stunning backdrop and breathtaking views of the valley. Explore the beauty of Solang Valley and visit the historic Viceregal Lodge. Discover the charm of Manali's treehouses, offering panoramic views of lush green jungles and towering mountains from a lofty altitude of 10,500 ft. Travel to Manali through winding mountain roads, with awe-inspiring snowy peaks towering in the background, and immerse yourselves in the spiritual essence of this picturesque hill station, where love fills the air and romance awaits at every turn.
    `,
        ...
        "it": [
            ...
            },
            {
                ...
                "Schedule": [
                    ...
                    { "Scheduledetails": "Explore the Mall Road for shopping and dining." },
            ...
            },
            {
                ...
                "Schedule": [
                    ...
                    { "Scheduledetails": "Refresh yourself and depart for Delhi in the evening." },
                    { "Scheduledetails": "Board the overnight Volvo bus to Delhi." }
                ]
            },
            {
    ...
    },
    {
        icon: "Accommodation",
        name: "Accommodation",
        inc: '2 night stay with 2 overnight journey. (Delhi to Delhi)'
    },
    {
        icon: "Meals",
        name: "Meals",
    ...
    },
    {
        icon: "Traveler",
        name: "Sedan Car",
        inc: 'Everyday commute by a Non Ac Sedan/Suv. all inner line permits for the trip; driver night charges, toll tax, parking charges.'
    },
    {
        icon: "Tickets",
        name: "Volvo Tickets",
    ...
    exclusion: [
        ...
        },
        {
            ...
            inc: `If Suv/Sedan is unable to move due to Snowfall, Landslide, etc. then Traveltech will not bear the extra charges of small 4x4. Either wait till clearing or Pay for the extra service.or Any cost arising due to natural calamities.`
        },
