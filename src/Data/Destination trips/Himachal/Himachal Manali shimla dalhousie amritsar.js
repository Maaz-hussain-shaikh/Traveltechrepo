const Shimlamanalidalhusie =
{
    ...
    brief: `Experience a romantic journey with TravelTech and explore the enchanting landscapes of Himachal Pradesh. Lose yourselves in the serene beauty of snow-capped mountains, lush deodar forests, and blooming wildflowers, with the Beas River gently flowing by. Discover the charm of Manali's Mall Road, with majestic views of the valley and the iconic Mall Road Manali in the backdrop. Marvel at the beauty of Solang Valley and uncover hidden gems like the historic Viceregal Lodge. Experience the allure of Manali's treehouses, offering panoramic views from 10,500 ft.

    Venture further into the Himalayas and explore the picturesque hill stations of Shimla and Dalhousie. In Shimla, stroll along the historic Ridge Road, visit the iconic Christ Church, and soak in the colonial charm of the Viceregal Lodge. Dalhousie awaits with its old-world charm, where you can visit St. John's Church, stroll through the serene Khajjiar Lake, and marvel at the panoramic views from Dainkund Peak.
    
    Continue your romantic escapade to the vibrant city of Amritsar, where you can visit the iconic Golden Temple, witness the beating retreat ceremony at the Wagah Border, and explore the historical Jallianwala Bagh. Indulge in the rich culinary delights of Punjab and experience the vibrant culture of this bustling city.
    
    With TravelTech as your trusted companion, let us make your romantic getaway an unforgettable experience! Explore Shimla, Dalhousie, and Amritsar with us to add more magic to your journey.`,
        ...
        "it": [
            {
                ...
                "Schedule": [
                    ...
                    { "Scheduledetails": "Reach Shimla by late afternoon." },
                    { "Scheduledetails": "Check into your hotel (double sharing basis) and have dinner (included)." },
                    { "Scheduledetails": "Overnight stay in Shimla." }
                ]
            },
            {
                ...
                "Schedule": [
                    ...
                    { "Scheduledetails": "Visit attractions such as the Mall Road, Christ Church, Jakhu Temple, and the Ridge." },
                    { "Scheduledetails": "Transfer to Kasol in the evening." },
                    { "Scheduledetails": "Dinner at the hotel (included)." },
                    { "Scheduledetails": "Overnight stay at Kasol." }
                ]
            },
            {
                ...
                "Schedule": [
                    ...
                    { "Scheduledetails": "Local sightseeing in Manali including Hadimba Temple, Manu Temple, Van Vihar, and the Tibetan Monastery." },
                    { "Scheduledetails": "Dinner at the hotel (included)." },
            ...
            },
            {
                ...
                "Schedule": [
                    ...
                    { "Scheduledetails": "Dinner en route to Dalhousie (not included)." },
                    { "Scheduledetails": "Overnight journey to Dalhousie." }
                ]
            },
            {
                ...
                "Schedule": [
                    ...
                    { "Scheduledetails": "Explore Dalhousie and Khajjiar." },
                    { "Scheduledetails": "Transfer to Amritsar in the evening." },
                    { "Scheduledetails": "Dinner at the hotel in Dalhousie (included)." },
                    { "Scheduledetails": "Overnight stay in Dalhousie." }
                ]
            },
            {
                ...
                "Schedule": [
                    ...
                    { "Scheduledetails": "Dinner on the way back to Delhi (not included)." },
    ...
    },
    {
        icon: "Accommodation",
        name: "Accommodation",
        inc: '5 night Standered stay with 2 overnight journey. (Delhi to Delhi)'
    },
    {
        icon: "Meals",
        name: "Meals",
    ...
    exclusion: [
        {
            ...
            icon: "Tickets",
            name: "Tickets",
            inc: "Monument entry tickets and expenses on any activities (Riverrafting, Paragliding, Snowactivities, Horse ride) which are not mentioned in the itinerary."
        },
        {
...
export default Shimlamanalidalhusie
